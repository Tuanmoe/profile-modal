...
export function PaymentTable({ payments }: PaymentTableProps) {
  return (
    <div className="space-y-2 sm:space-y-3 xl:space-y-1">
      {/* Header */}
      ...
      <div className="space-y-2 xl:space-y-1">
        {/* ACOMPTE Row */}
        <div className="grid grid-cols-3 gap-1 sm:gap-3 lg:gap-4 px-2 sm:px-4 py-2 sm:py-1 border-b text-xs sm:text-sm">
          <div className="text-cyan-500 text-sm sm:text-lg font-bold">ACOMPTE</div>
        ...
        {/* SOLDE RESTANT Row */}
        <div className="grid grid-cols-3 gap-1 sm:gap-3 lg:gap-4 px-2 sm:px-4 py-2 sm:py-1 border-b text-xs sm:text-sm">
          <div className="text-blue-500 text-sm sm:text-lg font-bold">SOLDE RESTANT</div>
